...
--------------------------------
--LENGTH : 문자열의 길이(문자단위)
--LENGTHB : 문자열의 길이(BYTE)
SELECT LENGTH('ABCDE123#$') FROM DUAL; -- 문자 단위 : 10
SELECT LENGTHB('ABCDE123#$') FROM DUAL; -- BYTE 단위 : 10

SELECT LENGTH('홍길동123') FROM DUAL; --문자 단위 : 6
...
SELECT INSTR('900101-1234567', '1', 1,2) FROM DUAL; --6 : 처음부터 찾고 두번째 찾은 위치
