...
--FLOOR(숫자) : 소수점 아래 버림
SELECT FLOOR(30.999), FLOOR(30.111) FROM DUAL;

--CEIL(숫자) : 올림 
SELECT CEIL(30.9999), CEIL(30.00001) FROM DUAL;

--ROUND(숫자) : 반올림 - 소수점 이하 반올림
--ROUND(숫자, 자리수) : 자리수 이하 반올림 예) ROUND(95.789, 2) -> 95.79
SELECT ROUND (30.5) , ROUND (30.4) FROM DUAL;
SELECT ROUND (30.45,1) , ROUND (30.44, 1) FROM DUAL;
SELECT ROUND (30.445, 2) FROM DUAL;

----------------------------------
--TRUNC(숫자) : 정수만 남기고, 소수부 버림
--TRUNC(숫자, 자리수) : 정수 이하 자리수까지 유지 
SELECT TRUNC(30.99), TRUNC(30.59), TRUNC(30.49) FROM DUAL;
SELECT TRUNC(30.59, 1), TRUNC(30.5999999,1) FROM DUAL; 
