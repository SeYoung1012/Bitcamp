...
MINVALUE 1 MAXVALUE 9999999999999999999999999999999999999999999
INCREMENT BY 1
...
NOCACHE;
-----------------
--BOOK 테이블에 시퀀스 사용해서 데이터 입력처리
INSERT INTO BOOK
        (BOOKID, BOOKNAME, PUBLISHER, PRICE)
 VALUES (SEQ_BOOK.NEXTVAL,'시퀀스 사용', 'IT_BOOK', 25000);
SELECT * FROM BOOK ORDER BY BOOKID DESC;

SELECT SEQ_BOOK.NEXTVAL FROM DUAL; --프로젝트 때 쓸 수 있음.
-------------------------------------
