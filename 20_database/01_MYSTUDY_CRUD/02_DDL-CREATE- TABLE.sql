...
VALUES('HONG5', '홍길동5','1234', '서울시', '010-3333-3333');
COMMIT;
SELECT * FROM MEMBER
-------------------------------
-- 수정 : HONG4 전화번호 '010-2222-2222' 변경
-- 수정 : HONG4 주소를 '서울시'로 변경
...
UPDATE MEMBER 
    SET PASSWORD = '8888', PHONE = '010-8888-8888', ADDRESS = '서울시 강남구'
WHERE ID = 'HONG8';
COMMIT;
--4.삭제
...
--오류 발생 : 정수부 3자리 저장 가능한데, 4자리 저장 시도
...
INSERT INTO TEST (STR1, STR2) VALUES('ABCDEFGHIJ', '서강준'); --한글 3글자 * 3 = 9
INSERT INTO TEST (STR1, STR2) VALUES('ABCDEFGHIJ', '대한민국'); --한글 4글자 * 3 = 12

-----------------------

/* *******NULL(널)의 특성 ************
--NULL(널) : 데이터가 없는 상태
--NULL은 비교처리가 안됨 : =, <>, !=, >, <, >=, <= 비교처리 의미 없음 : NULL처리된다
--NULL 과의 연산결과는 항상 NULL(연산 의미 없음)
--NULL 값에 대한 조회는 US NULL, IS NOT NULL 키워드로 처리
*********************************/
...
SELECT * FROM TEST ORDER BY NUM NULLS LAST; -- NULL 값을 맨마지막에 선택
----------------------------
--NULL 값 처리
SELECT NUM, NUM + 100 FROM TEST;
