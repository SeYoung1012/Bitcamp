...
public class CalendarExam {
	...
	public static void main(String[] args) {
		...
		date = new Date(2021-1900, 7 -1 ,29); //입력된 연도값에 1900이 더해진 결과
		System.out.println(date);
		
		System.out.println("----Calendar-----");
		Calendar cal = Calendar.getInstance();
		System.out.println(cal);
		//java.util.GregorianCalendar[time=1627537885466,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo
