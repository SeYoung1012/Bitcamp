...
public class ScissorsGame {
	...
	public void startGame() {
		...
		while (oneMoreGame) {
			// 0. 컴퓨터가 가위, 바위, 보 선택(Math.random() or Random)

			int comSelect = (int) (Math.random() * 3) + 1;
//			System.out.println("랜덤comSelect : " + comSelect);
//			comSelect =2;
//			System.out.println("comSelect: " + comSelect);
			
			// 1. 가위, 바위, 보 선택 메뉴 출력
			System.out.println("가위  바위 보 중에서 하나를 선택하시오.");
			...
			case 3:
				...
				break;
			default:
				System.out.println("1~3중에 하나를 선택하세요.");
			}
