...
public class Ex02_String_method {
	public static void main(String[] args) {
		...
		System.out.println("str4.startsWith(\"Java\" ) :" + str4.startsWith(str4));
		...
		// beginIndex : 시작위치값부터(포함)
		// endIndex : end 이전까지(불포함)
		System.out.println("str.substring(2, 4) : " + str.substring(2, 4));
		System.out.println(str.substring(0, str.length()));

		// 뒤에서 2개 문자 제외하고
		System.out.println("str.substring(0, str.length) : " + str.substring(0, str.length() - 2));
		...
		System.out.println("" + num + 1); // 문자열 붙이기 (문자열 1001 로 나옴)
